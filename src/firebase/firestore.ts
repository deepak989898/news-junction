...
function mapNewsDoc(id: string, data: Record<string, unknown>): NewsArticle {
  return {
    ...
    correctionStatus: (data.correctionStatus as string) || undefined,
    correctionNoteHi: (data.correctionNoteHi as string) || undefined,
    correctionNoteEn: (data.correctionNoteEn as string) || undefined,
    correctedAt: (data.correctedAt as Timestamp) || (data.correctedAt as string) || null,
    factCheckStatus: (data.factCheckStatus as string) || undefined,
    contentCreationMethod: (data.contentCreationMethod as string) || undefined,
    aiAssisted: data.aiAssisted !== undefined ? Boolean(data.aiAssisted) : undefined,
    humanReviewed: data.humanReviewed !== undefined ? Boolean(data.humanReviewed) : undefined,
    aiDisclosureHi: (data.aiDisclosureHi as string) || undefined,
    aiDisclosureEn: (data.aiDisclosureEn as string) || undefined,
    imageSourceType: (data.imageSourceType as string) || undefined,
